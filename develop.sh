...
docker run \
  ...
  --volume $(pwd)/server/notifyReportingServer.js:/tangerine-server/server/notifyReportingServer.js \
  ...
  --volume $(pwd)/reporting/package.json:/tangerine-server/reporting/package.json \
  --volume $(pwd)/reporting/index.js:/tangerine-server/reporting/index.js \
  --volume $(pwd)/reporting/controllers:/tangerine-server/reporting/controllers \
  --volume $(pwd)/reporting/utils:/tangerine-server/reporting/utils \
  --volume $(pwd)/reporting/public:/tangerine-server/reporting/public \

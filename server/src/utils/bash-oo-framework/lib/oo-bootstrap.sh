...
System::ImportOne() {
  ...
  echo "Found importOne:  $requestedPath"
  ...
  # try local library
  {
    ...
    echo "Found localPath:  $localPath"
...
System::Bootstrap
echo "aliasing import comand" 
alias importy="__oo__allowFileReloading=false System::Import"

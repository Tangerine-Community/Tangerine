...
@Component({
  selector: 'app-case-events-review-list-item',
  templateUrl: './case-events-review-list-item.component.html',
  styleUrls: ['./case-events-review-list-item.component.css']
})
export class CaseEventsReviewListItemComponent implements AfterContentInit {

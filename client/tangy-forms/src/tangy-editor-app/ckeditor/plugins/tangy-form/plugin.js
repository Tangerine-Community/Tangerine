...
CKEDITOR.plugins.add( 'tangy-form', {
	...
	init: function( editor ) {
		...
		CKEDITOR.dialog.add( 'tangy-form', this.path + 'dialogs/tangy-form.js' );

		// Register the tangy-form widget.
		editor.widgets.add( 'tangy-form', {
			// Allow all HTML elements, classes, and styles that this widget requires.
			// Read more about the Advanced Content Filter here:
			// * http://docs.ckeditor.com/#!/guide/dev_advanced_content_filter
			// * http://docs.ckeditor.com/#!/guide/plugin_sdk_integration_with_acf
			allowedContent:
				'div(!tangy-form,align-left,align-right,align-center){width};' +
				'div(!tangy-form-content); h2(!tangy-form-title); tangy-section();',

			// Minimum HTML which is required by this widget to work.
			requiredContent: 'div(tangy-form)',
			...
			template:
				'<tangy-form> <div class="content"> Add sections...' +
				'</div></tangy-form>',
			...
			// editor.lang.tangy-form.* property. A string was used directly here to simplify this tutorial.
			button: 'Create a tangy-form',
			...
			upcast: function( element ) {
				...
				// for all <div> elements with a "tangy-form" class.
				return element.name == 'tangy-form' ;
			},
			...
			data: function() {
				...
				// The style is set on widget main element (div.tangy-form).
				if ( this.data.width == '' )

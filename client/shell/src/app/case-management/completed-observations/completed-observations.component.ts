...
@Component({
  ...
  templateUrl: './completed-observations.component.html',
  styleUrls: ['./completed-observations.component.css']
})
export class CompletedObservationsComponent implements OnInit {
  observations = [];
  constructor(

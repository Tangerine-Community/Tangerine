...
import AcasiStyleEngine from './acasistyle/acasistyleengine';
import ButtonView from '@ckeditor/ckeditor5-ui/src/button/buttonview';

/**
 * The image style plugin.
 *
 * Uses the {@link module:image/imagestyle/imagestyleengine~AcasiStyleEngine}.
 *
 * @extends module:core/plugin~Plugin
 */
export default class AcasiStyle extends Plugin {
  /**
   * @inheritDoc
   */
  static get requires() {
  ...
  init() {
    ...
    const styles = editor.plugins.get( AcasiStyleEngine ).imageStyles;
   ...
   *
   * @private
   * @param {module:image/imagestyle/imagestyleengine~AcasiStyleFormat} style
   */
  _createButton( style ) {
    const editor = this.editor;
 ...
 * The option is used by the {@link module:image/imagestyle/imagestyleengine~AcasiStyleEngine} feature.
 *
 ...
 *
 * See {@link module:image/imagestyle/imagestyleengine~AcasiStyleEngine.defaultStyles} to learn more about default
 * styles provided by the image feature.
 *
 * The {@link module:image/imagestyle/imagestyleengine~AcasiStyleEngine.defaultStyles default styles} can be customized,
 * e.g. to change the icon, title or CSS class of the style. The feature also provides several
 * {@link module:image/imagestyle/imagestyleengine~AcasiStyleEngine.defaultIcons default icons} to chose from.
 *
 ...
 *		};
 *
 * Note: Setting `title` to one of {@link module:image/imagestyle/imagestyleengine~AcasiStyleEngine#localizedDefaultStylesTitles}
 ...
 *		};
 *
 * @member {Array.<module:image/imagestyle/imagestyleengine~AcasiStyleFormat>} module:image/image~ImageConfig#styles
 */

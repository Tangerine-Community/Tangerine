...
import { Component, OnInit, ViewChild, ElementRef, AfterContentInit, OnDestroy, ChangeDetectionStrategy } from '@angular/core';
...
export class EventFormComponent implements OnInit, OnDestroy {
  ...
  onEventFormOpen(){
    eval(this.eventFormDefinition.onEventFormOpen)
  }

  ngOnDestroy(){
    eval(this.eventFormDefinition.onEventFormClose)
  }
}

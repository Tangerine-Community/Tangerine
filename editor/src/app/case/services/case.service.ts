...
class CaseService {
  ...
  async load(id:string) {
    const data = await this.tangyFormService.getResponse(id)
    await this.setCase(new Case(data))
  }
  ...
  async getQuestionMarkup(form: string, question): Promise<string> {
    return await this.tangyFormService.getFormMarkup(form);
  }

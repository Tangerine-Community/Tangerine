...
@NgModule({ schemas: [CUSTOM_ELEMENTS_SCHEMA],
    ...
    bootstrap: [AppComponent], imports: [RouterModule,
        ...
        BrowserAnimationsModule], providers: [httpInterceptorProviders, TangyErrorHandler,
        WindowRef, { provide: HTTP_INTERCEPTORS, useClass: RequestInterceptor, multi: true }, { provide: APP_BASE_HREF, useValue: './' }, provideHttpClient(withXhr(), withInterceptorsFromDi())] })

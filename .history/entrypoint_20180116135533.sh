...
echo "Whitelist"
cd /tangerine-server/client && npm install cordova-plugin-whitelist && sleep 15 
echo "pwd: "
pwd 
echo "Add Whitelist"
cd /tangerine-server/client && ./node_modules/.bin/cordova plugin add cordova-plugin-whitelist --save 
echo "Geo"
cd /tangerine-server/client && npm install cordova-plugin-geolocation && sleep 15 
echo "Add Geo"
cd /tangerine-server/client && ./node_modules/.bin/cordova plugin add cordova-plugin-geolocation --save 
echo "Camera"
cd /tangerine-server/client && npm install cordova-plugin-camera && sleep 15 
echo "Add Camera"

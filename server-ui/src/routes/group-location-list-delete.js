...
module.exports = async (req, res) => {
  ...
  if (locationInfo.id == 'location-list') {
    ...
    try {
      await writeFile(`/tangerine/groups/${groupId}/client/location-list.json`, JSON.stringify({
        "id": "location-list",
    ...
    try {
      const locationsPath = `/tangerine/groups/${groupId}/client/locations/${locationInfo.id}.json`

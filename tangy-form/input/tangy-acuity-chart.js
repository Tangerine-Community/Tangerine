     ...
     -->
        ...
        Letter charts (class='chart V') are created dynamically in PageLetterChart() -->
                    ...
                    <div style="display:none;" id="list-character">
                        ...
                        <svg id="Auckland_A" class="optotype-symbol" xmlns="http://www.w3.org/2000/svg" version="1.1"
                             viewBox="0,0,4,5" height="8.73mm" style="margin: 3.49mm;">
                            <path
                        ...
                        <svg id="Auckland_B" class="optotype-symbol" xmlns="http://www.w3.org/2000/svg"
                             version="1.1"
                             viewBox="0,0,4,5" height="8.73mm" style="margin: 3.49mm;">
                            <path
                        ...
                        <svg id="Auckland_C" class="optotype-symbol" xmlns="http://www.w3.org/2000/svg"
                             version="1.1"
                             viewBox="0,0,4,5" height="8.73mm" style="margin: 3.49mm;">
                            <path
                        ...
                        <svg id="Auckland_D" class="optotype-symbol" xmlns="http://www.w3.org/2000/svg"
                             version="1.1"
                             viewBox="0,0,4,5" height="8.73mm" style="margin: 3.49mm;">
                            <path

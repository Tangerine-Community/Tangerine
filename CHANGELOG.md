...
- Editor fixes
  - We are recommending the use of 2-way sync for all forms due to mixed protocol risks when using sync-protocol-2. We have mode some modifications to the sync code based on load tests.

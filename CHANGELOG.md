...
- Added backup and restore feature for Tangerine databases using device encryption. Increase the appConfig.json parameter `dbBackupSplitNumberFiles` (default: 50) if your database is large to avoid crashes while backing up and/or restoring. PR: [#2884](https://github.com/Tangerine-Community/Tangerine/pull/2884)
- 

...
- New Features 
  ...
  - Server Admin creates group on command line with local or remote content set [#2174](https://github.com/Tangerine-Community/Tangerine/issues/2174) [[demo](https://youtu.be/dGo4C90aAto)]
- Bug Fixes

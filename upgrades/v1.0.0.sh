...
do
  curl -X POST -H 'Content-Type: application/json' -d @/tangerine/documents-for-new-groups/LocationList.json http://$T_ADMIN:$T_PASS@$T_COUCH_HOST:$T_COUCH_PORT/$database
done
